...
class CustomCell: UITableViewCell, AVAudioPlayerDelegate {
    ...
    @IBOutlet var audioDurationProgressLabel: UILabel!
    ...
    @IBAction func handlePlayButton(_: Any) {
    ...
    @IBAction func handleSpeedButton(_: Any) {
    ...
    @IBAction func handleEditButton(_: Any) {
